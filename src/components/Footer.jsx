...
function Footer() {
  return (
    <footer className="w-full bg-[#F3F6FF]">
      ...
      {/* CTA Section */}
      <div className="bg-[#2962FF] py-6 mx-4 sm:mx-6 lg:mx-8 my-8 rounded-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-white mb-4 md:mb-0">
            <h3 className="text-xl font-bold mb-1">Let's Get Connected And Start</h3>
            <p className="text-lg">Finding Your Dream Job</p>
          </div>
          <button className="bg-white text-blue-600 px-5 py-2.5 rounded hover:bg-gray-100 font-medium text-sm">
            Click Here
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <div>
            <div className="flex items-center mb-3">
              <div className="bg-[#2962FF] w-7 h-7 rounded flex items-center justify-center mr-2">
                <Briefcase className="text-white" size={18} />
              </div>
              <span className="text-lg font-bold">DataXhire/<span className="text-blue-600">Job</span></span>
            </div>
          ...
          {/* Useful Links */}
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 text-sm md:text-base">Useful Links</h4>
            <ul className="space-y-1.5 text-gray-600 text-xs md:text-sm">
              <li><a href="#" className="hover:text-blue-600">Find a Job</a></li>
              <li><a href="#" className="hover:text-blue-600">Companies</a></li>
              <li><a href="#" className="hover:text-blue-600">About Us</a></li>
              <li><a href="#" className="hover:text-blue-600">Post a Job</a></li>
          ...
          {/* Category */}
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 text-sm md:text-base">Category</h4>
            <ul className="space-y-1.5 text-gray-600 text-xs md:text-sm">
              <li><a href="#" className="hover:text-blue-600">Data Analyst</a></li>
              <li><a href="#" className="hover:text-blue-600">Data Scientist</a></li>
              <li><a href="#" className="hover:text-blue-600">Data Engineer</a></li>
          ...
          {/* Follow Us */}
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 text-sm md:text-base">Follow Us</h4>
            <ul className="space-y-1.5 text-gray-600 text-xs md:text-sm">
          ...
          {/* Newsletter */}
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 text-sm md:text-base">Newsletter</h4>
            <p className="text-gray-600 text-xs md:text-sm mb-3">
              Sign up to receive updates & offers
            </p>
            <div className="flex">
              <input
                type="email"
                placeholder="Email Address"
                className="flex-1 px-3 py-1.5 border border-gray-300 rounded-l outline-none focus:border-blue-600 text-xs md:text-sm"
              />
              <button className="bg-[#2962FF] text-white px-3 py-1.5 rounded-r hover:bg-blue-700 text-xs md:text-sm">
                Send
              </button>
            </div>
          </div>
        ...
        {/* Copyright */}
        <div className="border-t border-gray-200 mt-8 pt-6 text-center text-gray-600 text-xs md:text-sm">
          © 2025 <span className="text-blue-600 font-semibold">DataXHire/Job</span>. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
